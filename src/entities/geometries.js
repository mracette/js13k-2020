...
import playerFaceUpperConfig from './geometries/player_face_upper.json';
import playerFaceLowerConfig from './geometries/player_face_lower.json';
...
import macheteConfig from './geometries/machete.json';
...
export const playerFaceUpper = new BlenderGeometry(playerFaceUpperConfig);
export const playerFaceLower = new BlenderGeometry(playerFaceLowerConfig);
...
export const machete = new BlenderGeometry(macheteConfig);
